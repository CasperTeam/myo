...
async def cb_handler(client,query):
    ...
    if data == "ipe":
        ...
        await query.message.edit_text(
            text = f"Notes",
            reply_markup = InlineKeyboardMarkup(
            [[InlineKeyboardButton('Atomic Structure download', url='https://vid.ourclg.tech/0:/NOTES/CHEMISTRY/PHYSICAL/Atomic%20Structure/')],
        ...
        await query.message.edit_text(
            text = f"Notes",
            reply_markup = InlineKeyboardMarkup(
            [[InlineKeyboardButton('Chemichal Equilibrium download', url='https://vid.ourclg.tech/0:/NOTES/CHEMISTRY/PHYSICAL/Chemical%20Equlibrium/')],
            [InlineKeyboardButton('Back', callback_data='ipe1che')],]
        ))
    elif data == "cipeck":
        await query.message.edit_text(
            text = f"Notes",
            reply_markup = InlineKeyboardMarkup(
            [[InlineKeyboardButton('chemichal Kinetics download', url='https://vid.ourclg.tech/0:/NOTES/CHEMISTRY/PHYSICAL/Chemical%20Kinetics/')],
            [InlineKeyboardButton('Back', callback_data='ipe1che')],]
        ))
    elif data == "cipesom":
        await query.message.edit_text(
            text = f"Notes",
            reply_markup = InlineKeyboardMarkup(
            [[InlineKeyboardButton('states of matter download', url='https://vid.ourclg.tech/0:/NOTES/CHEMISTRY/PHYSICAL/States%20of%20Matter/')],
            [InlineKeyboardButton('Back', callback_data='ipe1che')],]
        ))
    elif data == "cipestcm":
        await query.message.edit_text(
            text = f"Notes",
            reply_markup = InlineKeyboardMarkup(
            [[InlineKeyboardButton('staichometry download', url='https://vid.ourclg.tech/0:/NOTES/CHEMISTRY/PHYSICAL/Stoichiometry/')],
            [InlineKeyboardButton('Back', callback_data='ipe1che')],]
        ))
    elif data == "cipetc":
        await query.message.edit_text(
            text = f"Notes",
            reply_markup = InlineKeyboardMarkup(
            [[InlineKeyboardButton('thermo chemistry download', url='https://vid.ourclg.tech/0:/NOTES/CHEMISTRY/PHYSICAL/Thermochemistry/')],
            [InlineKeyboardButton('Back', callback_data='ipe1che')],]
        ))
    elif data == "cipetd":
        await query.message.edit_text(
            text = f"Notes",
            reply_markup = InlineKeyboardMarkup(
            [[InlineKeyboardButton('thermodynamics download', url='https://vid.ourclg.tech/0:/NOTES/CHEMISTRY/PHYSICAL/Thermodynamics/')],
            [InlineKeyboardButton('Back', callback_data='ipe1che')],]
        ))
